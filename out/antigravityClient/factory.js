...
async function createAntigravityClient(outputChannel, configOverrides, workspacePath) {
    ...
    const client = new client_1.AntigravityClient({
        port,
        csrfToken,
        oauthToken,
        extensionServerPort: configOverrides?.extensionServerPort ?? processInfo?.extensionServerPort,
        extensionServerCsrfToken: configOverrides?.extensionServerCsrfToken ??
