...
const debugCommands = __importStar(require("./commands/debug"));
...
async function activate(context) {
    ...
    state.setModelsLoading(!state.hostBlocked);
    ...
    if (!state.hostBlocked) {
        try {
            await vscode.window.withProgress({
                ...
                title: "Ralph Loop: loading models",
            }, async () => {
                await (0, modelCatalog_1.prewarmDiscoveredModels)();
            });
        }
        finally {
    ...
    const commands = [
        ...
        vscode.commands.registerCommand("ralph.setConfigModelFallbackPriority", () => configCommands.setConfigModelFallbackPriority(context)),
        ...
        vscode.commands.registerCommand("ralph.debugConversationRegistration", () => debugCommands.debugConversationRegistration(context)),
